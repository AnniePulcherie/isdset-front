        ...
        <main>
          ...
          <div className="row">
              ...
              <div className="col-md-4" key={formation.id}>
                  <Card style={{ width: '20rem', margin: '10px', height: '22rem'}}>
                  
                  <Card.Body style={{ justifyContent:'space-between'}}>
                      <Card.Title>{formation.typeFormation}</Card.Title>
                      <Card.Text>
                      <strong>Frais generaux :</strong> {formation.fraisGeneraux}
                      <br />
                      <strong>Droit d'inscription :</strong> {formation.droitInscription}
                       <br />
                      <strong>Ecolage :</strong> {formation.ecolage} 
                      <br />
                      <strong>Payement de l'ecolage :</strong> {formation.tranche}
                      <br />
                      <strong>Durée de formation :</strong> {formation.duree}
                      <br />
                      <strong>Droit d'examen :</strong> {formation.droitExamen}
                      </Card.Text>
